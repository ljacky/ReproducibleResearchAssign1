...
ggplot(byDateData, aes(x=date, y=steps)) +
     geom_col() +
     labs(title = "steps by day", ylab="sum of steps")
```
...
ggplot(byIntDataMean, aes(x=interval, y=steps)) +
     geom_line() + 
     labs(title = "steps per 5 minute interval", ylab="mean steps")
...
ggplot(byDateImpData, aes(x=date, y=steps)) +
     geom_col() + 
     labs(title = "Imputed steps by day", ylab="sum of steps")
...
WDplot<-ggplot(byIntDataMeanWD, aes(x=interval, y=steps)) +
     geom_line() + 
     labs(title = "Weekdays", ylab="mean steps")
...
WEplot<-ggplot(byIntDataMeanWE, aes(x=interval, y=steps)) +
     geom_line()+ 
     labs(title = "Weekends", ylab="mean steps")
